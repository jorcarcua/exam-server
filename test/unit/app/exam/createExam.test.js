    ...
    describe("validator returns error", () =>{
        ...
        beforeAll( async () =>{ 
            ...
            const MockExamRepository = {
                createExam: async (id) => {return error}
            }   
          
         createExam = action({examRepository:MockExamRepository, examValidator:MockExamValidator}) 
    ...
    describe("validation is correct", () => {
       ...
       describe("exam exists", () => { 
        ...
        beforeAll( async () =>{ 
           ...
           const MockExamRepository = {
               createExam: async (id) => {return exam}
           }    
          createExam = action({examRepository:MockExamRepository, examValidator:MockExamValidator}) 
        })
        ...
        describe("exam doesn't exists", () => {
            ...
            beforeAll( async () =>{ 
                ...
                const MockExamRepository = {
                    createExam: async (exam) => {return null}
                }   
